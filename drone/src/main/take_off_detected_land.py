...
def main(argv):
    ...
    # 🔻🔻🔻 START OF MODIFIED try: BLOCK 🔻🔻🔻
    try:
        qr_detected = False
        move_up_attempts = 0
        last_move_time = time.time()
        timeout_durations = [6, 10]  # seconds before moving up
        ...
        while True:
            ...
            # Handle ascending logic after 10s and 15s if QR not detected
